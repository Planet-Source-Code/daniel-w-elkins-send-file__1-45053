...
StatusBar.SimpleText = "Status : Connecting to Recipient . . ."
End Sub
...
Close #FileNum
StatusBar.SimpleText = "Status : File Received."
RecData.Close
RecInfo.Close
On Error Resume Next
RecInfo.Listen
...
StatusBar.SimpleText = "Status : Receiving File . . ."
End Sub
...
StatusBar.SimpleText = "Status : Unable to Receive File."
End Sub
...
Case "F"
    ...
    iRep = MsgBox(RecInfo.RemoteHostIP & " would like to send you the file " & Chr$(34) & sBuff(2) & Chr$(34) & " (" & sBuff(3) & " Bytes). Accept ?", vbQuestion + vbYesNo, "File Transfer Request")
        ...
        Else
            ...
            StatusBar.SimpleText = "Status : Negotiating Transfer . . ."
            RecInfo.SendData sRetPack
        End If
...
StatusBar.SimpleText = "Status : Sending File . . ."
End Sub
...
StatusBar.SimpleText = "Status : File Sent."
SendData.Close
...
Dim sPack As String
bCon = True
StatusBar.SimpleText = "Status : Requesting Transfer . . ."
...
Case "F"
    ...
    If sBuff(2) = "Denied" Then
        StatusBar.SimpleText = "Status : User Denied Request."
...
SendTotal = 0
bCon = False
StatusBar.SimpleText = "Status : Unable to Connect to Recipient."
End Sub
